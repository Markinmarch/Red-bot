...
FILTERS_MESSAGE = {
    'delete_post': 'В номере записи не может содержаться букв и другиз символов.',
    ...
    'create_post': {
        'repeat_title': 'Пожалуйста, опишите деятельность короче. Необходимо написать не менее двадцати символов.',
